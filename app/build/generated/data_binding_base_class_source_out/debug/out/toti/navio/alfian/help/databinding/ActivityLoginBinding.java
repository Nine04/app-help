...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final Spinner jabatanLogin;
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull EditText emailLogin, @NonNull Spinner jabatanLogin, @NonNull TextView loginText,
      @NonNull EditText passwordLogin) {
    this.rootView = rootView;
    this.btnLogin = btnLogin;
    this.emailLogin = emailLogin;
    this.jabatanLogin = jabatanLogin;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.jabatanLogin;
      Spinner jabatanLogin = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, emailLogin,
          jabatanLogin, loginText, passwordLogin);
    }
